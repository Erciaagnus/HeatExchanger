...
def main():
    ...
    ap.add_argument("--in", dest="in_csv", default = "../../data/constrained_LHS_100k.csv", help="Input design CSV (sampled variables)")
    ap.add_argument("--out", dest="out_csv", default="../../data/porous_from_design.csv", help="Output CSV path")
